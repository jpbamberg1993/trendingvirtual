...
(function() {
  App.comments = App.cable.subscriptions.create("CommentsChannel", {
    ...
    connected: function() {
      return setTimeout((function(_this) {
        return function() {
          return _this.followCurrentArticle();
        };
      })(this), 1000);
    },
    ...
    followCurrentArticle: function() {
      var articleId;
      articleId = this.collection().data('article-id');
      if (articleId) {
...
(function() {
  $(document).ready(function() {
    $('body').on('click', 'a.reply-comment-btn', function() {
      return $(this).parents('.comment-footer').find('.reply-comment-form').toggleClass('hidden');
    });
    $('.best_in_place').best_in_place();
    $('body').on('click', 'a.toggle-replies', function() {
      var replyState;
      ...
      return $(this).parents('.row').next('.comment-replies').toggleClass('hidden');
    });
    $('body').on('click', 'a.read-more', function() {
      $(this).parent().addClass('hide');
      return $(this).parent().siblings().removeClass('hide');
    });
    $('body').on('click', 'a.read-less', function() {
      $(this).parent().addClass('hide');
      return $(this).parent().siblings().removeClass('hide');
    });
    return $('body').on('click', 'a.edit-btn', function() {
      var comment;
